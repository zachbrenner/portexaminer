...
This application uses Ruby 2.6.6, Ruby on Rails version 4.2.8, postgreSQL, Sidkiq (job scheduler/concerrency), Bootstrap, Nokogiri (html parser), and unicorn (webserver)
